 ...
 */
public class RoundGreenBranch extends AbstractBranchStyle implements IDrawable {

    private static final Color FILLCOLOR = new Color(161,207,169);

    
    
    RoundGreenBranch(Branch branch) {
         super(branch);
    }
